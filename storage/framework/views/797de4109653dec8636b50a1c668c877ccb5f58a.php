            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            type="text" 
                            class="form-control form-control-user <?php $__errorArgs = ['first_name'];
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            type="text" 
                            class="form-control form-control-user <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                        ...
                        <input 
                            type="text" 
                            class="form-control form-control-user <?php $__errorArgs = ['mobile_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            name="mobile_number" 
                            value="<?php echo e(old('mobile_number') ? old('mobile_number') : $user->mobile_number); ?>">
...
unset($__errorArgs, $__bag); ?>" name="status">
                            ...
                            <option value="1" <?php echo e(old('role_id') ? ((old('role_id') == 1) ? 'selected' : '') : (($user->status == 1) ? 'selected' : '')); ?>>Active</option>
                            <option value="0" <?php echo e(old('role_id') ? ((old('role_id') == 0) ? 'selected' : '') : (($user->status == 0) ? 'selected' : '')); ?>>Inactive</option>
                        </select>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-admin\resources\views/users/edit.blade.php ENDPATH**/ ?>