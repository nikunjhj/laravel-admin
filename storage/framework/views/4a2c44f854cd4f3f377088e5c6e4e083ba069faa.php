        ...
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <img class="rounded-circle mt-5" width="150px" src="<?php echo e(asset('admin/img/undraw_profile.svg')); ?>">
                    <span class="font-weight-bold"><?php echo e(auth()->user()->full_name); ?></span>
                    <span class="text-black-50"><i>Role:
                            <?php echo e(auth()->user()->roles
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    value="<?php echo e(old('first_name') ? old('first_name') : auth()->user()->first_name); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('last_name') ? old('last_name') : auth()->user()->last_name); ?>"
...
unset($__errorArgs, $__bag); ?>" name="mobile_number"
                                    value="<?php echo e(old('mobile_number') ? old('mobile_number') : auth()->user()->mobile_number); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="password" name="new_confirm_password" class="form-control <?php $__errorArgs = ['new_confirm_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel-admin\resources\views/profile.blade.php ENDPATH**/ ?>